            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 py-20">
                ...
                <div className="max-w-2xl mx-auto mb-20">
                    <form onSubmit={handleSearch} className="relative group">
                        ...
                        <div className="relative flex p-2 bg-white/10 border border-white/10 rounded-[2.5rem] backdrop-blur-xl">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 animate-in fade-in slide-in-from-bottom-10 duration-700">
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                .map((item, i) => (
                                    <div key={i} className="p-6 rounded-[2rem] bg-white/10 border border-white/5">
                            ...
                            <div className="p-8 rounded-[3rem] bg-white/10 border border-white/5 space-y-6">
                            ...
                            <div className="mt-8 flex justify-center">
                                <button 
                                    ...
                                    className="flex items-center gap-2 px-8 py-4 bg-white/10 hover:bg-white/10 text-white rounded-2xl font-black text-xs uppercase tracking-widest transition-all border border-white/10 shadow-xl"
                                >
