    ...
    <div className="p-10 max-w-7xl mx-auto space-y-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {clubs.map(club => (
          <div 
            key={club.id} 
            className={`p-10 rounded-[2.5rem] border transition-all hover:scale-[1.02] cursor-default group ${isDarkMode ? 'bg-[#161b2a]border-slate-800 hover:border-blue-500/30' : 'bg-white/40 border-slate-100 shadow-sm'}`}
          >
