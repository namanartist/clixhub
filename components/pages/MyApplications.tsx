        ...
        <div className="grid grid-cols-1 gap-8">
          {myApps.map((app) => {
            ...
            return (
              <div
                key={app.id}
                className="rounded-[2.5rem] border border-white/5 bg-white/10 overflow-hidden transition-all hover:border-white/10 hover:shadow-xl"
              >
                {/* Top color accent */}
                <div
                ...
                <div className="p-8 md:p-10">
                  ...
                  <div className="flex flex-wrap justify-between items-start gap-6 mb-8">
                    ...
                    <div className="flex flex-col items-end gap-2">
                      ...
                      <div className="flex items-center gap-2 px-4 py-2 bg-white/10 border border-white/10 rounded-xl group">
                  ...
                  {!isRejected ? (
                    <div className="space-y-6 mb-8">
                      ...
                      {/* Stage hint */}
                      <div className="p-5 rounded-2xl bg-white/10 border border-white/5 flex flex-col gap-4">
                        ...
                        {app.stage === 'Offer' && (
                            <div className="flex flex-col sm:flex-row gap-4 pt-4 border-t border-white/5 animate-in slide-in-from-top-2">
                                ...
                                <button 
                                    ...
                                    className="px-6 h-14 bg-white/10 text-slate-400 rounded-xl font-black text-[10px] uppercase tracking-widest hover:bg-rose-500/10 hover:text-rose-400 transition-all"
                                >
                                    Decline
                                </button>
                                <button 
                  ...
                  {isExpanded && (
                    <div className="mt-6 p-6 rounded-2xl bg-white/10 border border-white/5 space-y-4 animate-in slide-in-from-top-4 duration-300">
